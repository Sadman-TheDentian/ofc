  ...
  return (
    <div className="container py-12 md:py-20">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-20">
        <Card className="flex flex-col bg-gradient-to-br from-card to-card/80">
          <CardHeader>
        ...
        <Card className="border-primary border-2 shadow-lg shadow-primary/10 flex flex-col bg-gradient-to-br from-card to-card/80">
           <CardHeader>
