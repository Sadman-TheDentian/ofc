...
// This part is for static generation, but we can't fully use it with client components.
// We'll handle metadata in a different way if truly needed, for now we remove it as it's not compatible with 'use client'
/*
