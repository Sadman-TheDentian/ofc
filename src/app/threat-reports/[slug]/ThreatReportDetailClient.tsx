        ...
        <div className="min-h-screen bg-black pt-40 pb-20 overflow-hidden">
            <div className="container px-4">
                ...
                <div className="max-w-6xl mb-32">
                    ...
                    >
                        <Link href="/threat-reports" className="group flex items-center gap-3 text-[10px] font-bold text-white/30 uppercase tracking-[0.4em] mb-16 hover:text-red-500 transition-colors">
                        ...
                        <h1 className="text-6xl md:text-[8vw] font-[900] tracking-tighter text-white uppercase italic leading-[0.8] mb-12">
                            {report.title}
                        </h1>
                    ...
                    <div className="lg:col-span-8">
                        ...
                        >
                            ...
                            <div className="absolute bottom-12 left-12 flex items-center gap-6">
                                ...
                                <span className="text-[10px] font-black text-white tracking-[0.6em] uppercase">MISSION_ASSET_v{report._id.slice(-4).toUpperCase()}</span>
                            </div>
                        </motion.div>
