-- Password Leak Monitoring System - Production Database Schema
-- Clean PostgreSQL Schema for NeonDB (Production Ready)
...
-- Payment transactions table - Coinbase Commerce focused
CREATE TABLE payment_transactions (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    payment_provider VARCHAR(50) NOT NULL, -- 'coinbase_commerce', 'stripe', 'paypal'
